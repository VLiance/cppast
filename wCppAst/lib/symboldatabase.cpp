...
void SymbolDatabase::createSymbolDatabaseVariableSymbolTable()
{
 ...
 //   printf("#\n------!!!! createSymbolDatabaseVariableSymbolTable add all variables#\n-");
...
void Scope::getVariableList(const Library* lib)
{
   ...
   // printf("\ngetVariableList %s", tok->str().c_str());
